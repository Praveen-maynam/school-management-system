...
function LoginScreen() {
  ...
  return (
    <div className="min-h-screen bg-white overflow-auto">
      ...
      {/* Saved Users Table (Static) */}
      <div className="max-w-2xl mx-auto mt-8 bg-white rounded-xl shadow p-6">
        <h4 className="text-2xl font-semibold mb-4">Saved Users:</h4>
        <table className="min-w-full border border-gray-200">
          <thead>
            <tr className="bg-gray-100">
              <th className="px-4 py-2 border-b text-left text-base font-medium text-gray-700">Email</th>
              <th className="px-4 py-2 border-b text-left text-base font-medium text-gray-700">Password</th>
              <th className="px-4 py-2 border-b text-left text-base font-medium text-gray-700">Role</th>
            </tr>
          </thead>
          <tbody>
            <tr
            ...
            >
              <td className="px-4 py-2 border-b text-base text-gray-800">admin@school.com</td>
              <td className="px-4 py-2 border-b text-base text-gray-800">admin123</td>
              <td className="px-4 py-2 border-b text-base text-gray-800">Admin</td>
            </tr>
            <tr   className="cursor-pointer hover:bg-blue-50 transition"
              ...
              <td className="px-4 py-2 border-b text-base text-gray-800">superadmin@school.com</td>
              <td className="px-4 py-2 border-b text-base text-gray-800">super123</td>
              <td className="px-4 py-2 border-b text-base text-gray-800">Super Admin</td>
            </tr>
            <tr className="cursor-pointer hover:bg-blue-50 transition"
              onClick={() => {
                setEmail('parent1@example.com');
                setPassword('parentpass1');
              }}>
              <td className="px-4 py-2 border-b text-base text-gray-800">parent1@example.com</td>
              <td className="px-4 py-2 border-b text-base text-gray-800">parentpass1</td>
              <td className="px-4 py-2 border-b text-base text-gray-800">Parent</td>
            </tr>
            <tr className="cursor-pointer hover:bg-blue-50 transition"
              onClick={() => {
                setEmail('teacher1@example.com');
                setPassword('teacherpass1');
              }}>
              <td className="px-4 py-2 border-b text-base text-gray-800">teacher1@example.com</td>
              <td className="px-4 py-2 border-b text-base text-gray-800">teacherpass1</td>
              <td className="px-4 py-2 border-b text-base text-gray-800">Teacher</td>
            </tr>
            <tr className="cursor-pointer hover:bg-blue-50 transition"
              onClick={() => {
                setEmail('financemgr@school.com');
                setPassword('fin123');
              }}>
              <td className="px-4 py-2 border-b text-base text-gray-800">financemgr@school.com</td>
              <td className="px-4 py-2 border-b text-base text-gray-800">fin123</td>
              <td className="px-4 py-2 border-b text-base text-gray-800">Finance Manager</td>
            </tr>
            <tr className="cursor-pointer hover:bg-blue-50 transition"
              onClick={() => {
                setEmail('librarymgr@school.com');
                setPassword('lib123');
              }}>
              <td className="px-4 py-2 border-b text-base text-gray-800">librarymgr@school.com</td>
              <td className="px-4 py-2 border-b text-base text-gray-800">lib123</td>
              <td className="px-4 py-2 border-b text-base text-gray-800">Library Manager</td>
            </tr>
            <tr className="cursor-pointer hover:bg-blue-50 transition"
              onClick={() => {
                setEmail('transportmgr@school.com');
                setPassword('trans123');
              }}>
              <td className="px-4 py-2 border-b text-base text-gray-800">transportmgr@school.com</td>
              <td className="px-4 py-2 border-b text-base text-gray-800">trans123</td>
              <td className="px-4 py-2 border-b text-base text-gray-800">Transport Manager</td>
            </tr>
            {/* <tr className="cursor-pointer hover:bg-blue-50 transition"
              onClick={() => {
                setEmail('inventorystaff@school.com');
                setPassword('inv123');
              }}>
              <td className="px-4 py-2 border-b text-base text-gray-800">inventorystaff@school.com</td>
              <td className="px-4 py-2 border-b text-base text-gray-800">inv123</td>
              <td className="px-4 py-2 border-b text-base text-gray-800">Inventory Staff</td>
            </tr > */}
            {/* <tr className="cursor-pointer hover:bg-blue-50 transition"
              onClick={() => {
                setEmail('examstaff@school.com');
                setPassword('exam123');
              }}>
              <td className="px-4 py-2 border-b text-base text-gray-800">examstaff@school.com</td>
              <td className="px-4 py-2 border-b text-base text-gray-800">exam123</td>
              <td className="px-4 py-2 border-b text-base text-gray-800">Exam Staff</td>
            </tr> */}
            {/* <tr className="cursor-pointer hover:bg-blue-50 transition"
              onClick={() => {
                setEmail('superadmin@school.com');
              ...
              <td className="px-4 py-2 border-b text-base text-gray-800">patient@example.com</td>
              <td className="px-4 py-2 border-b text-base text-gray-800">123456</td>
              <td className="px-4 py-2 border-b text-base text-gray-800">Patient</td>
            </tr> */}
          </tbody>
        </table>
      </div>
