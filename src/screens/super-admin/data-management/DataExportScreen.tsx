...
//               <button className="flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-slate-700 hover:text-slate-900 hover:bg-slate-100 rounded-lg transition-all">
...
//                 {exports.map(exp => (
//                   <div key={exp.id} className="p-6 hover:bg-slate-50 transition-colors">
...
//                             <span key={scope} className="px-2 py-1 bg-indigo-50 text-indigo-700 text-xs rounded-md">
//                               {scope.replace(/_/g, ' ')}
//                             </span>
//                           ))}
//                         </div>
...
//                             <span key={type} className="px-2 py-1 bg-slate-100 text-slate-700 text-xs rounded-md">
//                               {type}
//                             </span>
//                           ))}
//                         </div>
...
//                         <button className="flex items-center gap-2 px-4 py-2 bg-slate-100 text-slate-700 text-sm font-medium rounded-lg hover:bg-slate-200 transition-colors">
//                           <Download className="w-4 h-4" />
//                           Download
//                         </button>
...
//               <div className="p-6 space-y-6">
//                 <div className="p-5 bg-rose-50 border-l-4 border-rose-500 rounded-lg">
//                   <div className="flex gap-3">
...
//                   <div key={deletion.id} className="p-6 hover:bg-slate-50 transition-colors">
...
//                         </div>
//                       </div>
//                       <button className="flex items-center gap-2 px-3 py-2 bg-slate-100 text-slate-700 text-xs font-medium rounded-lg hover:bg-slate-200 transition-colors">
