        ...
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                ...
                <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center">
                    ...
                    <ResponsiveContainer width="100%" height={250}>
                        <BarChart data={topSchools} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
                            <CartesianGrid strokeDasharray="3 3" />
                            <XAxis dataKey="name" />
                            <YAxis />
                            <Tooltip />
                            <Legend />
                            <Bar dataKey="total" fill="#2563eb" name="Total Users" />
                        </BarChart>
                    </ResponsiveContainer>
                </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
                <h2 className="text-lg font-semibold mb-4">Top Schools (Details)</h2>
